[CmdletBinding()]
param (
    [Parameter(HelpMessage = "deploy.parameters.psd1", Mandatory = $false)]
    [ValidateScript( { Test-Path $_ })]
    [string]
    $paramsFile = "$PSScriptRoot/deploy.parameters.psd1",
    [Parameter(HelpMessage = "62366534-1ec3-4962-8869-9b5535279d0b", Mandatory = $false)]
    [string]
    $subscription = "62366534-1ec3-4962-8869-9b5535279d0b"
)
